...
<div class="container-fluid">
	<form action="" id="manage-group">
		...
		<div class="form-group">
			<label for="group_num" class="control-label">Group Number / Name</label>
			<input type="text" class="form-control form-control-sm" name="group_num" id="group_num" value="<?php echo isset($group_num) ? $group_num : '' ?>" required>
		</div>
	</form>
</div>
<script>
