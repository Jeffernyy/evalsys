	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<table width="100%">
					...
					<tr>
						<td width="50%"><p><b>Group No.: <span id="subjectField"></span></b></p></td>
						<td width="50%"><p><b>Total Peer Respondent: <span id="tse"></span></b></p></td>
					</tr>
			</table>
...
<script>
	...
	function anchor_func(){
		$('.show-result').click(function(){
			...
			window.history.pushState({}, null, './index.php?page=report&fid='+vars.fid+'&gid='+data.group_id);
