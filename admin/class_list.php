	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_class" href="javascript:void(0)"><i
		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT *,concat(program,' ',year,'-',section) as `class` FROM class_l order by class asc "); //(apparently I lost the class_l table)
					while ($row = $qry->fetch_assoc()):
						...
						<tr>
							...
							<td class="text-center">
								<div class="btn-group">
									<a href="javascript:void(0)" data-id='<?php echo $row['class_id'] ?>'
										class="btn btn-primary btn-flat manage_class">
										<i
											class="fas fa-edit"></i><!--<ion-icon src="C:\xampp\htdocs\evalsys\create-outline.svg"></ion-icon>-->
									</a>&nbsp;
