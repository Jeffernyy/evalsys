...
<div class="col-lg-12">
	<h3 class="h3-responsive text-dark"><strong>
			<?php echo "SY " . $qry['year'] ?>
			<?php echo $qry['semester'] . ' Sem' ?><strong></h3>
		...
		<div class="col-md-12">
			<div class="callout callout-info" id="printable">
				...
				<div class="card-tools">
					<a class="btn btn-sm btn-default btn-flat border-primary new_criteria" href="javascript:void(0)"><i
							class="fa fa-plus"></i> Add New Criteria</a>
					<a class="btn btn-sm btn-default btn-flat border-primary new_quest" href="javascript:void(0)"><i
...
<script>
	$(document).ready(function () {
		...
		$('.new_criteria').click(function () {
			uni_modal("New Criteria", "<?php echo $_SESSION['login_view_folder'] ?>add_criteria.php")
		})
