	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_student"><i
				...
				<tbody>
					...
					while ($row = $qry->fetch_assoc()):
						...
						<tr>
							...
							<td><b>
									<?php echo isset($class[$row['class_id']]) ? $class[$row['class_id']] : "N/A" ?>
								</b></td>
