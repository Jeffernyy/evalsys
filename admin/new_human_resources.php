...
<div class="col-lg-12">
  <div class="card">
    <div class="card-body">
      <form action="" id="manage_human_resources">
        ...
        <div class="col-lg-12 text-right justify-content-center d-flex">
          ...
          <button class="btn btn-secondary" type="button"
            onclick="location.href = 'index.php?page=human_resources_list'">Cancel</button>
        </div>
      </form>
    </div>
  </div>
...
<script>
  ...
  $('#manage_human_resources').submit(function (e) {
    e.preventDefault()
    ...
    $.ajax({
      url: 'ajax.php?action=save_human_resources',
      ...
      success: function (resp) {
        if (resp == 1) {
          ...
          window.location.href = 'index.php?page=human_resources_list';
        } else if (resp == 2) {
