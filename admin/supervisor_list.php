	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_supervisor"><i
						class="fa fa-plus"></i> Add New Supervisor</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM supervisor_list order by concat(firstname,' ',lastname) asc");
						...
						<tr>
							...
							<td class="text-center">
								...
								<div class="dropdown-menu" style="">
									<a class="dropdown-item view_supervisor" href="javascript:void(0)"
										data-id="<?php echo $row['id'] ?>">View</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="./index.php?page=edit_supervisor&id=<?php echo $row['id'] ?>">Edit</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item delete_supervisor" href="javascript:void(0)"
